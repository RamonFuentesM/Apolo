...
def infoCommands():
    ...
    if objetivo_entry_info.get() != "":
        ...
        if escaneres_infg[2]:
            comandos.append("python3 Herramientas/theHarvester/theHarvester.py -d " + quitarHttps(objetivo_entry_info.get()) + " -b google,linkedin,twitter,yahoo,duckduckgo,bing | tee reportes/Escaner" + str(num_scanner+1) + "/TheHarvester_InformationGathering.txt")
